...
- Name: Reporters.spec.js >> Test 2
- Location: tests\Reporters.spec.js:10:5
...
- table:
  ...
  - rowgroup:
    - row "Internet Explorer 7.1 Mbps 4.7% 0.32 MB/s 51.5 MB":
      - cell "Internet Explorer"
      - cell "7.1 Mbps"
      - cell "4.7%"
      - cell "0.32 MB/s"
      - cell "51.5 MB"
    - row "System 7.9 Mbps 9.5% 0.55 MB/s 35.3 MB":
      - cell "System"
      - cell "7.9 Mbps"
      - cell "9.5%"
      - cell "0.55 MB/s"
      - cell "35.3 MB"
    - row "Firefox 7.7 Mbps 3.7% 0.71 MB/s 70.2 MB":
      - cell "Firefox"
      - cell "7.7 Mbps"
      - cell "3.7%"
      - cell "0.71 MB/s"
      - cell "70.2 MB"
    - row "Chrome 4.4 Mbps 1.2% 0.71 MB/s 61.9 MB":
      - cell "Chrome"
      - cell "4.4 Mbps"
      - cell "1.2%"
      - cell "0.71 MB/s"
...
```ts
  ...
  6  |     expect(page).toHaveTitle("STORE")
  7  | 
  8  | })
  9  | 
...
> 13 |     expect(page).toHaveTitle("Automation Testing Practic")
     |                  ^ Error: expect(page).toHaveTitle(expected) failed
  14 | 
  15 | })
```